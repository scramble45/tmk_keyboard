...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * `---'   `---------------' `---------------' `---------------' `-----------'     `-----------'
     * ,-----------------------------------------------------------. ,------------. ,---------------.
     * |  `|  1|  2|  3|  4|  5|  6|  7|  8|  9|  0|  -|  =|Backspa| |LGUI|Hom|PgU| |NmL|  /|  *|  -|
     * |-----------------------------------------------------------| |------------| |---------------|
    ...
    ESC, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, BSPC,     LGUI, HOME,PGUP,    NLCK,PSLS,PAST,PMNS,
     ...
     */
    KEYMAP(
	ESC, PWR, SLEP, WAKE, F4, F5, MPRV, MPLY, MNXT, MUTE, VOLU, VOLD, F12,        PSCR, SLCK, BRK,
...
const uint16_t PROGMEM fn_actions[] = {
    ...
    [1] = ACTION_MODS_KEY(MOD_LSFT, KC_HOME),    // tilde
};
